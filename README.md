...
A tiny Fabric client mod for Minecraft 1.21.11 that removes the item-switch
("equip") animation — the little dip/rise the held item does when you
change hotbar slots. With this mod, switching slots is instant.
